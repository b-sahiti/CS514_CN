...
class FatTreeTopo(Topo):    
	...
	self._set_ovs_protocol_13(self.coreList)
	self._set_ovs_protocol_13(self.aggList)
	self._set_ovs_protocol_13(self.edgeList)
        ...
        for p in pods:
            ...
            for e in edge_sws:
                ...
                for h in hosts:
                    ...
                    self.addLink(host_id, edge_id, host_port, edge_port,bw=96)
                    # self.addLink(host_id, edge_id, host_port, edge_port, bw=96,enable_ecn=True,enable_red=True)
                    # self.addLink(host_id, edge_id, host_port, edge_port, bw=96, enable_ecn=True)
                ...
                for a in agg_sws:
                    ...
                    self.addLink(edge_id, agg_id, edge_port, agg_port,bw=96)
                    # self.addLink(edge_id, agg_id, edge_port, agg_port, bw=96,enable_ecn=True,enable_red=True)
                    # self.addLink(edge_id, agg_id, edge_port, agg_port, bw=96, enable_ecn=True)
                    edge_port += 1
                agg_port += 1
            ...
            for a in agg_sws:
                ...
                for c in core_sws:
                    ...
                    self.addLink(core_id, agg_id, p+1, agg_port,bw=96)
                    # self.addLink(core_id, agg_id, p + 1, agg_port, bw=96,enable_ecn=True,enable_red=True)
                    # self.addLink(core_id, agg_id, p + 1, agg_port, bw=96, enable_ecn=True)
                    agg_port += 1
